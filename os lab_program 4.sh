...
---------------------------
Enter your choice: 1
Enter filename to create: program1.sh
Enter content: hello
File 'program1.sh' created successfully.
---------------------------
FILE MANAGEMENT PROGRAM
1. Create File
2. Copy File
...
---------------------------
Enter your choice: 2
Enter source filename: program1.sh
Enter destination filename: copy.sh
...
5. Display File
Enter your choice: 3
Enter filename to move: program1.sh
Enter new filename: program2.sh
...
---------------------------
Enter your choice: 4
Enter filename to delete: agney1
...
6. Exit
Enter your choice: 5
Enter filename to display: agney2
Content of 'agney2':
world---------------------------
FILE MANAGEMENT PROGRAM
1. Create File
